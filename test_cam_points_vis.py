...
device_id_top = "1844301021D9BF1200"
device_id_side = "1844301071E7AB1200"
device_info = dai.DeviceInfo(device_id_side)

print(f"Connecting to DepthAI PointCloud camera with ID: {device_id_side} ...")
device = dai.Device(pipeline, device_info)
print(f"Connected to DepthAI PointCloud camera with ID: {device_id_side}")
